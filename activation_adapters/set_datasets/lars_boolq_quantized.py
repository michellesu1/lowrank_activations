...
def main():
    ...
    print(type(base_model.model.layers[0].self_attn.q_proj))
    ...
    model = get_peft_model(base_model, lars_config, autocast_adapter_dtype=True)
    model._mark_only_adapters_as_trainable(model)
